...
public class MockFlightGeneratorController {
    ...
    public MockFlightGenerationResponse generateFlights(@Valid @RequestBody MockFlightGenerationRequest request, @AuthenticationPrincipal Jwt jwt, HttpServletRequest httpServletRequest){
